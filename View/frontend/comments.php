...
<div class="common-background comments-background">
                    ...
                    <div class="modal-content">
                        <div class="col s12 m12 l12">
                            <div class="row">
                                ...
                                <section class="col col s12 m12 l8 offset-l2">
                                    <p class="center">
                                ...
                                <form action="addNewComment" method="post">
                                    ...
                                    <div class='rating-widget col s12 m12 l2'>
                                    ...
                                    <div class="col s12 m12 l12 center">
                                        <button type="submit" name="submit" id="<?= empty($_SESSION['username']) ?  'test' : 'comment-form-btn'; ?>" onclick="commentAndRefresh()" class="btn waves-effect waves-light cyan darken-2 disabled">Poster mon commentaire</button>
                                    </div>
