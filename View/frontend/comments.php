...
<div class="container">
    ...
    <h2 class="page-title center">Commentaires</h2>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="col s12 m12 l10">
                            ...
                            <p class="grey-text">Publié le <?= date("d/m/Y", strtotime($response->date)) ?></p>
                            <p><?= nl2br($response->comment) ?></p>
                            <a href="index.php?url=warning&id=<?= $response->id ?>" class="right">Signaler ce commentaire</a>
                        </div>
